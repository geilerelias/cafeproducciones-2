...
<template>
    <div v-if="items.length>0" class="lb">
        <div :class="[css,items.length>cells?'lb-grid-' + cells: 'lb-grid-' + items.length]" class="lb-grid">
            <div v-for="(src, i) in items" v-if="i<cells" :style="bg(src)" class="lb-item" @click="show(i)">
        ...
        <transition enter-active-class="animated fadeIn" leave-active-class="animated fadeOut">
            <div v-if="index>=0" class="lb-modal">
                ...
                <div class="lb-modal-img d-flex justify-center align-center" @click="close">
                    <v-img :src="src" class="mx-auto" contain
